...
public class BasePickerView {
    ...
    protected void initViews(){
        ...
        contentContainer = (ViewGroup) rootView.findViewById(com.bigkoo.pickerview_new.R.id.content_container);
    ...
    public BasePickerView setCancelable(boolean isCancelable) {
        View view = rootView.findViewById(com.bigkoo.pickerview_new.R.id.outmost_container);
