...
import com.bigkoo.pickerview_new.adapter.WheelAdapter;
import com.bigkoo.pickerview_new.listener.OnItemSelectedListener;
import com.bigkoo.pickerview_new.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(com.bigkoo.pickerview_new.R.color.pickerview_wheelview_textcolor_out);
        textColorCenter = getResources().getColor(com.bigkoo.pickerview_new.R.color.pickerview_wheelview_textcolor_center);
        dividerColor = getResources().getColor(com.bigkoo.pickerview_new.R.color.pickerview_wheelview_textcolor_divider);
        //配合customTextSize使用，customTextSize为true才会发挥效果
        textSize = getResources().getDimensionPixelSize(com.bigkoo.pickerview_new.R.dimen.pickerview_textsize);
        customTextSize = getResources().getBoolean(com.bigkoo.pickerview_new.R.bool.pickerview_customTextSize);
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.WheelView, 0, 0);
            mGravity = a.getInt(R.styleable.WheelView_pickerview_gravity_s, Gravity.CENTER);
            textColorOut = a.getColor(com.bigkoo.pickerview_new.R.styleable.WheelView_pickerview_textColorOut, textColorOut);
            textColorCenter = a.getColor(com.bigkoo.pickerview_new.R.styleable.WheelView_pickerview_textColorCenter, textColorCenter);
            dividerColor = a.getColor(com.bigkoo.pickerview_new.R.styleable.WheelView_pickerview_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(com.bigkoo.pickerview_new.R.styleable.WheelView_pickerview_textSize, textSize);
        }
