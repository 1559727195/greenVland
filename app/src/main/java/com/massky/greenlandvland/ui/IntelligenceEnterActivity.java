...
public class IntelligenceEnterActivity extends AppCompatActivity {
    private ImageView drop;
    private RelativeLayout rl_intelligenceenter;
    private RelativeLayout rl_topenter;
    ...
    public static IntelligenceEnterActivity instance=null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intelligence_enter);
        instance=this;
        drop= (ImageView) findViewById(R.id.drop);
        rl_intelligenceenter= (RelativeLayout) findViewById(R.id.rl_intelligenceenter);
        btn_enter= (Button) findViewById(R.id.btn_enter);
        rl_topenter= (RelativeLayout) findViewById(R.id.rl_topenter);
        ...
        int position = getIntent().getIntExtra(EXTRA_IMAGE,2);
        height = getIntent().getIntExtra("height",0);
        width = getIntent().getIntExtra("width",0);
        top = getIntent().getIntExtra("top",0);

        rl_intelligenceenter.setBackgroundResource(string[position]);

        rl_intelligenceenter.post(new Runnable() {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.drop://下拉键
                    ...
                    break;
                case R.id.btn_enter:
                    startActivity(new Intent(IntelligenceEnterActivity.this,TransitActivity.class));
                    break;
            }
        }
    };
...
//        }
        ...
        Animator scale_Y = ObjectAnimator.ofFloat(detailImg, View.SCALE_Y, in ? s_img[0] : s_img[1],
                in ? s_img[1] : s_img[0]);
        Animator trans_T = ObjectAnimator.ofFloat(rl_topenter, View.TRANSLATION_Y, in ? t_img[0] : t_img[1],
                in ? t_img[1] : t_img[0]);
...
//                    pull_down.setVisibility(View.VISIBLE);
    ...
    public static void startActivity(Context context, int height, int top, int width, int position) {
        Intent intent = new Intent(context, IntelligenceEnterActivity.class);
        ...
        mHideAnimation.setAnimationListener(new Animation.AnimationListener()
        {
            ...
            public void onAnimationEnd(Animation arg0)
            {
                ...
                anim(width, height, top, false, new Runnable() {
                    @Override
                    public void run() {
                        IntelligenceEnterActivity.super.onBackPressed();
...
//        setHideAnimation(top_img, 200);
    ...
    private void showdialog() {
        AlertDialog.Builder builder=new AlertDialog.Builder(IntelligenceEnterActivity.this,1);
        builder.setTitle("提示");
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                startActivity(new Intent(IntelligenceEnterActivity.this, LoginActivity.class));
                SharedPreferencesUtils.cleanPassword(IntelligenceEnterActivity.this);
