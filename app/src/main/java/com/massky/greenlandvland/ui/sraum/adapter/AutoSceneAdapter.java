...
import com.massky.greenlandvland.ui.sraum.Util.MusicUtil;
...
import com.massky.greenlandvland.ui.sraum.widget.SlideSwitchForSwitchDeleteButton;
...
//        dialog.setCanceledOnTouchOutside(false);// 设置点击屏幕Dialog不消失
    ...
    private void linkage_delete(final String linkId, final Dialog dialog) {
        ...
        mapdevice.put("token", SharedPreferencesUtils.getToken(context));
