...
public class InviteVisitorsActivity extends AppCompatActivity {
    private ImageView drop;
    private RelativeLayout rl_invitevisitor;
    private RelativeLayout rl_topinvite;
    ...
    public static InviteVisitorsActivity instance=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_invitevisitor= (RelativeLayout) findViewById(R.id.rl_invitevisitor);
        btn_enter= (Button) findViewById(R.id.btn_enter);
        rl_topinvite= (RelativeLayout) findViewById(R.id.rl_topinvite);
        ...
        int position = getIntent().getIntExtra(EXTRA_IMAGE,4);
        height = getIntent().getIntExtra("height",0);
        width = getIntent().getIntExtra("width",0);
        top = getIntent().getIntExtra("top",0);

        rl_invitevisitor.setBackgroundResource(string[position]);

        rl_invitevisitor.post(new Runnable() {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.drop://下拉键
                    ...
                    break;
                case R.id.btn_enter:
                    startActivity(new Intent(InviteVisitorsActivity.this,InvitevisitorActivity.class));
                    break;
            }
        }
    };
...
//        }
        ...
        Animator scale_Y = ObjectAnimator.ofFloat(detailImg, View.SCALE_Y, in ? s_img[0] : s_img[1],
                in ? s_img[1] : s_img[0]);
        Animator trans_T = ObjectAnimator.ofFloat(rl_topinvite, View.TRANSLATION_Y, in ? t_img[0] : t_img[1],
                in ? t_img[1] : t_img[0]);
...
//                    pull_down.setVisibility(View.VISIBLE);
    ...
    public static void startActivity(Context context, int height, int top, int width, int position) {
        Intent intent = new Intent(context, InviteVisitorsActivity.class);
        ...
        mHideAnimation.setAnimationListener(new Animation.AnimationListener()
        {
            ...
            public void onAnimationEnd(Animation arg0)
            {
                ...
                anim(width, height, top, false, new Runnable() {
                    @Override
                    public void run() {
                        InviteVisitorsActivity.super.onBackPressed();
...
//        setHideAnimation(top_img, 200);
    ...
    private void showdialog() {
        AlertDialog.Builder builder=new AlertDialog.Builder(InviteVisitorsActivity.this,1);
        builder.setTitle("提示");
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                startActivity(new Intent(InviteVisitorsActivity.this, LoginActivity.class));
                SharedPreferencesUtils.cleanPassword(InviteVisitorsActivity.this);
