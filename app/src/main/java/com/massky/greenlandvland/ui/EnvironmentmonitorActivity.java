...
public class EnvironmentmonitorActivity extends AppCompatActivity {
    ...
    private RelativeLayout rl_environmentmonitor;
    ...
    public static EnvironmentmonitorActivity instance=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_environmentmonitor= (RelativeLayout) findViewById(R.id.rl_environmentmonitor);
        ...
        rl_environmentmonitor.setBackgroundResource(string[position]);

        rl_environmentmonitor.post(new Runnable() {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.drop://下拉键
                    ...
                    break;
                case R.id.btn_enter:
                    startActivity(new Intent(EnvironmentmonitorActivity.this,EnvironmentActivity.class));
                    break;
            }
        }
    };
...
//                    pull_down.setVisibility(View.VISIBLE);
    ...
    public static void startActivity(Context context, int height, int top, int width, int position) {
        Intent intent = new Intent(context, EnvironmentmonitorActivity.class);
        ...
        mHideAnimation.setAnimationListener(new Animation.AnimationListener()
        {
            ...
            public void onAnimationEnd(Animation arg0)
            {
                ...
                anim(width, height, top, false, new Runnable() {
                    @Override
                    public void run() {
                        EnvironmentmonitorActivity.super.onBackPressed();
...
//        setHideAnimation(top_img, 200);
    ...
    private void showdialog() {
        AlertDialog.Builder builder=new AlertDialog.Builder(EnvironmentmonitorActivity.this,1);
        builder.setTitle("提示");
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                startActivity(new Intent(EnvironmentmonitorActivity.this, LoginActivity.class));
                SharedPreferencesUtils.cleanPassword(EnvironmentmonitorActivity.this);
