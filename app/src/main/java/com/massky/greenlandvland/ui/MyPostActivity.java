...
import com.massky.greenlandvland.ui.adapter.PostAdapter;
...
public class MyPostActivity extends AppCompatActivity {
    ...
    private TabLayout post;
    private ViewPager viewPager;
    private PostAdapter postAdapter;
    private List<Fragment> fragmentList;
    public static MyPostActivity instance=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post= (TabLayout) findViewById(R.id.post);
    ...
    private void initData() {
        ...
        fragmentList.add(new MypostFragment());
        fragmentList.add(new ResponseFragment());

        postAdapter=new PostAdapter(MyPostActivity.this,getSupportFragmentManager(),fragmentList);
        viewPager.setAdapter(postAdapter);
        post.setupWithViewPager(viewPager);//把tablayout与viewPager绑定
        post.setTabMode(TabLayout.MODE_FIXED);//多个Tab无滑动效果
    }
    ...
    private void showdialog() {
        AlertDialog.Builder builder=new AlertDialog.Builder(MyPostActivity.this,1);
        builder.setTitle("提示");
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SharedPreferencesUtils.cleanPassword(MyPostActivity.this);
